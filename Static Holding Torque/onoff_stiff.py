...
# raw_data = pd.read_csv('../1-dof-experimental_data/lifting_723_9.csv')
...
filenames = ['../1-dof-experimental_data/lifting_85_4.csv', '../1-dof-experimental_data/lifting_85_2.csv', '../1-dof-experimental_data/lifting_86_3.csv']
